...
function ItemEditModal(props) {
  ...
  const fillTrack = () => {
    props.stores.TracksStore.fillNewTrack(props.trackEdit).then(
      props.setTrackEdit
    );
  };
  ...
  const [elapsedTimeFormat, setElapsedTimeFormat] = useState(
        ...
        <Form>
            ...
            <Col sm='9'>
              <DatePicker
                ...
                customInput={
                  <Form.Control
                    type='text'
                    value={dateTime.getFormat(
                      'YYYY-MM-DD',
                      props.trackEdit.date
                    )}
                  />
                }
              />
          ...
          <Form.Group controlId='formTicket' as={Row}>
            ...
            <Col sm='9'>
              <Form.Control
                ...
                placeholder='Ticket'
                onChange={event =>
                  changeTrackEdit('ticket', event.target.value)
                }
              />
            </Col>
          </Form.Group>
          ...
          <Form.Group controlId='formTicketTitle' as={Row}>
            ...
            <Col sm='9'>
              <Form.Control
                ...
                onChange={event =>
                  changeTrackEdit('ticketTitle', event.target.value)
                }
              />
            </Col>
          </Form.Group>
          <Form.Group controlId='formBranch' as={Row}>
            ...
            <Col sm='9'>
              <Form.Control
                ...
                placeholder='Branch'
                onChange={event =>
                  changeTrackEdit('branch', event.target.value)
                }
              />
            </Col>
          </Form.Group>
          ...
          <Form.Group controlId='formComment' as={Row}>
            ...
            <Col sm='9'>
              <Form.Control
                ...
                placeholder='Comment'
                onChange={event =>
                  changeTrackEdit('comment', event.target.value)
                }
              />
              {props.stores.Comments.items.map(comment => (
                <Button
                  variant='outline-primary'
                  className={'mr-2 mt-1'}
                  onClick={() => {
          ...
          <Form.Group controlId='formCheckbox'>
            <Form.Check
              ...
              onChange={event =>
                changeTrackEdit('overtime', event.target.checked)
              }
            />
          </Form.Group>
          <Form.Group controlId='formCheckbox'>
            <Form.Check
              ...
              onChange={event =>
                changeTrackEdit('savedJira', event.target.checked)
              }
            />
            <Form.Check
              sm='3'
              ...
              onChange={event =>
                changeTrackEdit('savedUTZ', event.target.checked)
              }
            />
          </Form.Group>
        </Form>
